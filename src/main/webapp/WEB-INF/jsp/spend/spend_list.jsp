...
<link
	...
	rel="stylesheet">
<!--
  <link rel="stylesheet" href="../../resources/css/log/cost/cost_common.css" type="text/css" />
  -->
<link rel="stylesheet" href="../../../css/ledger/style_mobile.css"
	media="screen and (min-width:320px) and (max-width:414px)"
	type="text/css" />
<link rel="stylesheet" href="../../../css/ledger/style_pad.css"
...
<!-- jvectormap -->
<link rel="stylesheet"
	href="../../../css/main/jquery-jvectormap-1.2.2.css">
<!-- Date Picker -->
...
<link rel="stylesheet"
	href="../../../css/main/bootstrap3-wysihtml5.min.css">
<!-- Google Font: Source Sans Pro 
   BootStrap.min 
  <link rel="stylesheet" href="../../resources/css/log/cost/bootstrap.min.css">-->
<!-- DataTable css -->
<link rel="stylesheet"
	href="../../../css/ledger/dataTables.bootstrap.min.css">
<!-- all_skin -->
<link rel="stylesheet" href="../../../css/ledger/_all-skins.min.css">
<!-- list.css -->
<link rel="stylesheet" href="../../../css/ledger/list.css">
<!-- jquery -->
<script type="text/javascript"
	src="../../../js/common/jquery-3.3.1.min.js"></script>
<!-- -->
<script type="text/javascript"
	src="../../../js/ledger/ledger_list_common.js"></script>
<script type="text/javascript">
		$(function () {
			gnbMenu('6');

			// 모바일용 리스트 열기/닫기
			$("a.arrow").on("mousedown", function () {
				$("ul.sale").find("li").removeClass("sel");
				$(this).parent("div").parent("div").parent("li").addClass("sel");
			});
		});

		function chkQuestion() {
			var frm = document.main;
			frm.action = "./cost_list.html";
			frm.target = "_self";
			frm.submit();
		}
	...
	<div class="wrapper">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						...
						<a href="#" class="dropdown-item"> <i
							class="fa fa-envelope mr-2"></i> 4 개의 주문 <span
							class="float-right text-muted text-sm">3 mins</span>
						</a>
						<div class="dropdown-divider"></div>
						<a href="#" class="dropdown-item"> <i class="fa fa-users mr-2"></i>
							8 개의 후기 <span class="float-right text-muted text-sm">12
								hours</span>
						</a>
						<div class="dropdown-divider"></div>
						<a href="#" class="dropdown-item"> <i class="fa fa-file mr-2"></i>
							&nbsp;3 개의 문의 <span class="float-right text-muted text-sm">2
								days</span>
						</a>
						<div class="dropdown-divider"></div>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				src="../../../images/main/AdminLTELogo.png" alt="AdminLTE Logo"
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="../../../images/main/user1-128x128.jpg"
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview"><a href="#"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									관리자 메뉴 <i class="right fa fa-angle-left"></i>
								</p>
						</a>
						...
						<li class="nav-item has-treeview"><a href="#"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									다중 메뉴 <i class="right fa fa-angle-left"></i>
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="pages/charts/chartjs.html"
						...
						<li class="nav-item"><a href="pages/widgets.html"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									단일 메뉴 <span class="badge badge-info right">7</span>
								</p>
						</a></li>
						<!-- 단일메뉴 -->
						...
						<li class="nav-item"><a href="pages/widgets.html"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									단일 메뉴 <span class="right badge badge-danger">7</span>
								</p>
						</a></li>
						<!-- 단일메뉴 -->
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">비용조회</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">비용조회</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">5월 비용 목록</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
												...
												<table id="example2"
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc" tabindex="0"
																...
																aria-sort="ascending"
																aria-label="Rendering engine: activate to sort column descending">일자</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="Browser: activate to sort column ascending">임대료</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="Platform(s): activate to sort column ascending">공과금</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="Engine version: activate to sort column ascending">인건비</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="CSS grade: activate to sort column ascending">기타/식대</th>
															<th class="sorting">총합</th>
														</tr>
													</thead>
													<tbody>
													...
													<tfoot>
														<tr>
															...
															<th rowspan="1" colspan="1">임대료</th>
															<th rowspan="1" colspan="1">공과금</th>
															<th rowspan="1" colspan="1">인건비</th>
															<th rowspan="1" colspan="1">식대/기타</th>
															<th>총합</th>
														</tr>
													</tfoot>
												</table>
